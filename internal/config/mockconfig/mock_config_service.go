...
// Source: internal/config/service/configurer_service.go
...
func (m *MockConfigurerService) SetApiHost(host string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetApiHost", host)
}

// SetApiHost indicates an expected call of SetApiHost.
func (mr *MockConfigurerServiceMockRecorder) SetApiHost(host interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetApiHost", reflect.TypeOf((*MockConfigurerService)(nil).SetApiHost), host)
}

// SetNetworkConfiguration mocks base method.
func (m *MockConfigurerService) SetNetworkConfiguration(network string, config entity.NetworkConfiguration) {
	m.ctrl.T.Helper()
...
func (mr *MockConfigurerServiceMockRecorder) SetNetworkConfiguration(network, config interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetNetworkConfiguration", reflect.TypeOf((*MockConfigurerService)(nil).SetNetworkConfiguration), network, config)
}
